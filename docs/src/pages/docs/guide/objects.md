---
title: Defining Objects Types
name: Objects
menu: Guide
description: Guide for defining Object types in Pothos GraphQL
---
...
we will use `@graphql-yoga/node` but you can use whatever server you want.
