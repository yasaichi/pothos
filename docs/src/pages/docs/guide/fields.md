---
name: Fields
title: Defining fields in Pothos
menu: Guide
description: Guide for defining fields in Pothos GraphQL
---
...
SchemaBuilder constructor, see [Changing Default Nullability](./changing-default-nullability).
